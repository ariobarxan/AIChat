...
struct CreateAvatarView: View {
    ...
    private var attributesSection: some View {
        var characterPicker: some View {
            Picker(selection: $characterOption, content: {
        ...
        var actionPicker: some View {
            Picker(selection: $characterAction, content: {
        ...
        var locationPicker: some View {
            Picker(selection: $characterLocation, content: {
